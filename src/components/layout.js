        ...
        <div className="flex min-h-screen flex-col">
            ...
            <footer className="flex justify-center bg-primary py-4">
                <a
                    ...
                    className="text-white transition-opacity hover:opacity-80 focus:outline-hidden focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-primary"
                >
